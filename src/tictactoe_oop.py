...
X = 'X'
O = 'O'
BLANK = ' ' # Constants for string values.

def main():
    """Runs a game of tic-tac1-toe."""
    print('Welcome to tic-tac-toe!')
    ### Changed for sub classgameBoard = TTTBoard() # Create a TTT board object.
    ...
    print(type(gameBoard).__qualname__)
